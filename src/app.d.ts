declare global {
	interface RTCRtpTransceiver {
		 ...
		 *
		 * _While this property is deprecated, at this time [**`currentDirection`**](https://developer.mozilla.org/en-US/docs/Web/API/RTCRtpTransceiver/currentDirection) is never set to `"stopped"` in Safari while this property continues to work across all browsers._
		 *
